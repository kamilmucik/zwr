...
const ScanScreen = ({navigation, route}) => {
    ...
    const fetchProduct = async (ean) => {
      ...
      if (appCtx.settingsWarehouse === ""){
        showMessage({
          message: "Zaloguj się aby wybrać magazyn",
          type: 'danger',
          position: 'top',
        });
      } else {
        console.log('warehouseIds: ' + appCtx.settingsWarehouse);
        setQuery(
          'productimageversion/findbyean?ean=' +
            ean +
            '&page=' +
            currentPage +
            '&pageSize=' +
            appCtx.settingsPageSize +
            '&warehouse=' +
            appCtx.settingsWarehouse,
        );
      }
    }
        ...
        <View style={styles.mainContainer}>
          ...
          <View>
            {appCtx.isDebugMode === true ? (
              <View>
                <Text>
                  {appCtx.settingsDestinationURL}/{query}
                </Text>
                  ...
                  <CustomImage
                    ...
                    onPress={() =>
                      navigation.navigate('ScanImage', {
                        ...
                        warehouse: appCtx.settingsWarehouse,
                        comment: d?.comment,
                        imgPath: d.imgPath,
