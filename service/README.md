...
mvn versions:set -DnewVersion=2.5.5 -DprocessAllModules -DgenerateBackupPoms=false
...
scp ./setup/setup-server/target/serwer-2.5.5.zip ubuntu@e-strix.pl:/home/ubuntu/wp/releases/megapack/2.5.5/serwer-2.5.5.zip
