...
public class ProductImageVersionRevisionEditController extends MainController implements Serializable {
    ...
    public void rerecognizeImageText(Long id) {
            if (id == null || id == 0) {
                ...
                String responseId = textExtractorService.extractTextFromImagePath(selectedItem.getImgPath());
    ...
    public void editItem(Long id) throws IOException {
        ...
        if (id == null || id == 0) {
            ...
            selectedItem = releaseService.getRevisionItem(id);
            updateVersionDialog = new UpdateVersionDialog(id, selectedItem.getVersionId(), selectedItem.getImgPath(), CustomStringUtils.prepareStringToCompare(selectedItem.getDescription()), selectedItem.getComment());
        }
    }
