...
@Component
@NoArgsConstructor
public class ShipmentLazyDataModel extends LazyDataModel<ShipmentDto> {
    ...
    public ShipmentLazyDataModel(ShipmentService storeService, UserDto userDto, String tableSearch) {
